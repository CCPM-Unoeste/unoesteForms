...
class FormOther extends React.Component {
    constructor() {
        super();
        this.state = {
            name: '',
    ...
    handlePhoneChange = e => {
        this.setState({ [e.target.name]: e.target.value.replace(/([0-9]{2})([0-9]{5})([0-9]{4})/, '($1) $2-$3') });
        e.target.value = e.target.value.replace(/([0-9]{2})([0-9]{5})([0-9]{4})/, '($1) $2-$3');
    }
        ...
        return (
            <div>
                <form onSubmit={this.handleSubmit}>
                    ...
                    <input type="text" name="phone" placeholder="###########" onChange={this.handlePhoneChange} required />
